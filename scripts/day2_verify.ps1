...
$RequiredPaths = @(
    ...
    @{ Label = "Model pricing rate model"; RelativePath = "backend\app\models\model_pricing_rate.py" },
    @{ Label = "Workflow run cost model"; RelativePath = "backend\app\models\workflow_run_cost.py" },
    @{ Label = "Model pricing rate schemas"; RelativePath = "backend\app\schemas\model_pricing_rate.py" },
    @{ Label = "Workflow run cost schemas"; RelativePath = "backend\app\schemas\workflow_run_cost.py" },
    @{ Label = "Model pricing rate repository"; RelativePath = "backend\app\repositories\model_pricing_rate_repository.py" },
    @{ Label = "Workflow run cost repository"; RelativePath = "backend\app\repositories\workflow_run_cost_repository.py" },
    @{ Label = "Cost calculation service"; RelativePath = "backend\app\services\cost_calculation_service.py" },
    @{ Label = "Cost API endpoints"; RelativePath = "backend\app\api\v1\endpoints\costs.py" },
    @{ Label = "Pricing seed Python helper"; RelativePath = "backend\scripts\seed_pricing_rates.py" },
    @{ Label = "Pricing seed PowerShell script"; RelativePath = "scripts\db_seed_pricing.ps1" },
    @{ Label = "Cost API smoke script"; RelativePath = "scripts\smoke_cost_calculation_api.ps1" },
    @{ Label = "Day 5 cost full verification script"; RelativePath = "scripts\day5_cost_full_verify.ps1" },
    @{ Label = "Cost model tests"; RelativePath = "backend\tests\test_cost_models.py" },
    @{ Label = "Cost schema tests"; RelativePath = "backend\tests\test_cost_schemas.py" },
    ...
    @{ Label = "Outcome Contract schemas"; RelativePath = "backend\app\schemas\outcome_contract.py" },
    @{ Label = "Workflow run outcome schemas"; RelativePath = "backend\app\schemas\workflow_run_outcome.py" },
    @{ Label = "Outcome metrics schemas"; RelativePath = "backend\app\schemas\outcome_metrics.py" },
    @{ Label = "Outcome Contract repository"; RelativePath = "backend\app\repositories\outcome_contract_repository.py" },
    @{ Label = "Workflow run outcome repository"; RelativePath = "backend\app\repositories\workflow_run_outcome_repository.py" },
    @{ Label = "Outcome service"; RelativePath = "backend\app\services\outcome_service.py" },
    @{ Label = "Outcome schema tests"; RelativePath = "backend\tests\test_outcome_schemas.py" },
    @{ Label = "Outcome repository import tests"; RelativePath = "backend\tests\test_outcome_repositories_imports.py" },
    @{ Label = "Outcome service tests"; RelativePath = "backend\tests\test_outcome_service_imports.py" },
    @{ Label = "Day 5 outcome service guide"; RelativePath = "docs\day-5-outcome-service-layer.md" },
    @{ Label = "Outcome API endpoints"; RelativePath = "backend\app\api\v1\endpoints\outcomes.py" },
    @{ Label = "Outcome API smoke script"; RelativePath = "scripts\smoke_outcome_tracking_api.ps1" },
    @{ Label = "Outcome route tests"; RelativePath = "backend\tests\test_outcome_route_registration.py" },
    @{ Label = "Outcome endpoint import tests"; RelativePath = "backend\tests\test_outcome_endpoint_imports.py" },
    @{ Label = "Day 5 outcome API guide"; RelativePath = "docs\day-5-outcome-apis.md" },
    @{ Label = "Day 5 full verification script"; RelativePath = "scripts\day5_full_verify.ps1" },
    @{ Label = "Day 5 final summary"; RelativePath = "docs\day-5-final-summary.md" },
    @{ Label = "Day 6 dashboard preparation"; RelativePath = "docs\day-6-dashboard-preparation.md" },
    @{ Label = "Day 6 starter prompt"; RelativePath = "docs\day-6-start-prompt.md" },
    @{ Label = "Dashboard schemas"; RelativePath = "backend\app\schemas\dashboard.py" },
    @{ Label = "Dashboard analytics service"; RelativePath = "backend\app\services\dashboard_analytics_service.py" },
    @{ Label = "Dashboard API endpoints"; RelativePath = "backend\app\api\v1\endpoints\dashboard.py" },
    @{ Label = "Dashboard API smoke script"; RelativePath = "scripts\smoke_dashboard_api.ps1" },
    @{ Label = "Day 6 dashboard full verification script"; RelativePath = "scripts\day6_dashboard_full_verify.ps1" },
    @{ Label = "Dashboard schema tests"; RelativePath = "backend\tests\test_dashboard_schemas.py" },
    @{ Label = "Dashboard service tests"; RelativePath = "backend\tests\test_dashboard_service_imports.py" },
    @{ Label = "Dashboard route tests"; RelativePath = "backend\tests\test_dashboard_route_registration.py" },
    @{ Label = "Dashboard endpoint import tests"; RelativePath = "backend\tests\test_dashboard_endpoint_imports.py" },
    @{ Label = "Day 6 dashboard analytics guide"; RelativePath = "docs\day-6-dashboard-analytics-api.md" },
    @{ Label = "Recommendation model"; RelativePath = "backend\app\models\recommendation.py" },
    @{ Label = "Recommendation schemas"; RelativePath = "backend\app\schemas\recommendation.py" },
    @{ Label = "Recommendation repository"; RelativePath = "backend\app\repositories\recommendation_repository.py" },
    @{ Label = "Recommendation service"; RelativePath = "backend\app\services\recommendation_service.py" },
    @{ Label = "Recommendation API endpoints"; RelativePath = "backend\app\api\v1\endpoints\recommendations.py" },
    @{ Label = "Recommendation API smoke script"; RelativePath = "scripts\smoke_recommendation_api.ps1" },
    @{ Label = "Day 6 recommendation full verification script"; RelativePath = "scripts\day6_recommendation_full_verify.ps1" },
    @{ Label = "Recommendation model tests"; RelativePath = "backend\tests\test_recommendation_models.py" },
    @{ Label = "Recommendation schema tests"; RelativePath = "backend\tests\test_recommendation_schemas.py" },
    @{ Label = "Recommendation service tests"; RelativePath = "backend\tests\test_recommendation_service_imports.py" },
    @{ Label = "Recommendation route tests"; RelativePath = "backend\tests\test_recommendation_route_registration.py" },
    @{ Label = "Recommendation endpoint tests"; RelativePath = "backend\tests\test_recommendation_endpoint_imports.py" },
    @{ Label = "Day 6 recommendation guide"; RelativePath = "docs\day-6-recommendation-api-foundation.md" },
    @{ Label = "Accelerated MVP timeline"; RelativePath = "docs\accelerated-mvp-timeline.md" },
